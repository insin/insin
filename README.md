...
<ul>
<li>
  <strong>2024-01-21</strong> – <a href="https://github.com/insin/control-panel-for-twitter">control-panel-for-twitter</a> <a href="https://github.com/insin/control-panel-for-twitter/releases/tag/v3.23.0">v3.23.0</a>
  <div><em>Browser extension which gives you more control over your Twitter timeline and adds missing features and UI improvements - available for desktop and mobile browsers</em></div>
  <details><summary>v3.23.0 release notes</summary><ul>
<li>Added an option to hide the new "Pro" menu item (enabled by default as it's a Premium upsell)</li>
<li>Hide Subscribe prompts in the timeline</li>
<li>Removed options for hiding menu items which have been removed by Twitter</li>
<li></li>
</ul>
<hr>
