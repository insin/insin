...
<ul>
<li>
  <strong>2023-09-29</strong> – <a href="https://github.com/insin/control-panel-for-twitter">control-panel-for-twitter</a> <a href="https://github.com/insin/control-panel-for-twitter/releases/tag/v3.19.0">v3.19.0</a>
  <div><em>Browser extension which gives you more control over your Twitter timeline and adds missing features and UI improvements - available for desktop and mobile browsers</em></div>
  <details><summary>v3.19.0 release notes</summary><ul>
<li>Added an option under "Hide Twitter Blue replies" to show replies from "verified" business accounts</li>
<li>Changed "Hide Twitter Blue replies" to be more aggressive by default
<ul>
<li>Replies from accounts with over 1 million followers are no longer shown by default</li>
<li>Replies from "verified" business accounts are no longer shown by default</li>
</ul>
</li>
<li>Changed formatting of Quote Tweet counts to only use the compact format for 10,000 and above</li>
<li>Fixed restored Quote Tweets/Retweets/Likes links not being added to certain tweets</li>
</ul>
<hr>
...
<hr>
<h2>Screenshots</h2>
<h3>New "Hide Twitter Blue replies" default options</h3>
<div class="markdown-alert markdown-alert-note"><p><span class="color-fg-accent text-semibold d-inline-flex flex-items-center mb-1"><svg class="octicon octicon-info mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>Note</span><br>
"Hide Twitter Blue replies" is not enabled by default - you need to enable it manually if you want to use it</p></div>
<p><a target="_blank" rel="noopener noreferrer" href="https://github.com/insin/control-panel-for-twitter/assets/226692/3176861e-dfe4-4b31-bf4d-c992a0b70220"><img src="https://github.com/insin/control-panel-for-twitter/assets/226692/3176861e-dfe4-4b31-bf4d-c992a0b70220" alt="VoREta1uyJ" style="max-width: 100%;"></a></p></details>
</li>
<li>
